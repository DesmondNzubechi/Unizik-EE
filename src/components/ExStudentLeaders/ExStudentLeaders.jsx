...
const ExStudentLeaders = [
    {
        ...
        message: {
            first: 'Dear Students and Future Leaders, As proud alumni of this esteemed institution, we stand before you as living testaments to the transformative power of education and resilience. We understand the challenges and opportunities that lie ahead, and we are here to offer guidance and support on your journey.',
...
export const ExDeptExcos = () => {
  ...
  <div className="bg-slate-50 p-5 py-[30px] relative flex flex-col gap-5 rounded overflow-y-auto">
    ...
    <div className="max-w-[450px] flex-col gap-4  ">
      <h1 className="font-semibold uppercase text-[20px] ">Message and encouragement to student</h1>
