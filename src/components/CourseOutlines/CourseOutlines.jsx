...
export const CourseOutline = () => { 
    return(
        ...
        <p><Link to='/Course-outlines' className="bg-slate-900  hover:bg-slate-700 mt-[10px] text-slate-50 rounded-[3px] shadow-2xl p-[10px] font-semibold text-[15px] md:text-[20px]  ">View course outline</Link>
        </p>
        </div>
        <div className=" "> 
