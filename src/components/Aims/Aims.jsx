...
export const SchoolEvents = () => {
  ...
  <div className="flex flex-col max-w-[600px] gap-[20px] ">
      <h1 className="text-[30px]  w-fit  rounded-[15px] text-slate-900 font-semibold ">Events<span className="text-[30px]  w-fit  rounded-[15px] text-slate-900 font-bold uppercase"></span> </h1>
  ...
  <p><Link to='/cgpa' className="bg-slate-500 text-[20px] text-slate-50 px-[10px] py-[5px] mt-[60px] font-semibold hover:bg-slate-900 rounded-[3px]  ">Checkout Events</Link>
  </p>
  </div>
