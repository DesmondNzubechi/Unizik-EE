...
export const AllNews = () => {
    ...
    const {  editNews, displaying,  allNews, allEvents, getFullNews, setAllNews, setDisplaying, setEditNews, } = useContext(fullNewsContext);
            ...
            /></div> } 
             {allNews?.map(news => {
                ...
                return  <div className="flex flex-col relative p-3 shadow-xl gap-3">
                    <p className="bg-slate-500 top-0 absolute">{ news.category}</p>
