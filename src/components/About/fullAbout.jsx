...
<h1 className="md:text-[25px] text-[20px] border-b-[7px] border-b-yellow-500 w-fit  font-bold uppercase rounded p-[2px] ">About ee unizik</h1>
        <div className=" flex flex-col gap-[50px] md:flex-row items-center py-[50px] ">
...
<p className="md:text-[15px] text-[12px] font-[400] ">7.Self-confidence and result oriented ability.  </p>
            ...
            <div className="flex flex-col py-[100px] gap-5">
     ...
     <ol className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1 ">
        ...
        <li className="md:text-[15px] font-[500] text-[12px] font-bold ">14. Prof. Dr. Ezechukwu Oseloka 2022 to Date.</li>
            ...
            <div className="flex md:flex-row-reverse pb-[100px] flex-col gap-5 items-center">
    ...
    <img src={tools} alt="" className="rounded" />
            ...
            <div className="flex flex-col gap-5 pb-[50px] items-center md:flex-row">
