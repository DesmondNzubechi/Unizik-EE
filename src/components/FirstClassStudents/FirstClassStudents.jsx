...
export const FirstClassGraduates = () => {
    ...
    return (
        ...
        <div className="py-[100px] flex justify-center bg-slate-50 px-[20px]">
            <div>
                <div>
                    <h1 data-aos='fade-up' aos-data-duration='2000' className="text-center uppercase text-[20px] md:text-[25px] font-bold my-[30px] ">Past students with first class honour🏅</h1>
                    <div className="grid grid-cols-1 gap-[40px] md:grid-cols-2 lg:grid-cols-3">
                      ...
                      setFullProfileVisibility('top-0')
                                    ...
                                    <div className="py-[10px] px-[10px] " >
                                        ...
                                        <h1 className="font-semibold text-slate-500 text-[12px]">First Class Honour 🏅</h1>
