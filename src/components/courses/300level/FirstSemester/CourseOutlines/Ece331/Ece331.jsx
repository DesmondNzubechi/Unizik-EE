...
import { Ece331Content } from "./Ece331content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">ECE 331  Signals and Systems 2 Credits</h1>
