...
import { Feg303Content } from "./Feg303content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">FEG 303  Engineering Mathematics III 3 Credits </h1>
