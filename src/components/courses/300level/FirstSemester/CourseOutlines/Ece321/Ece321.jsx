...
import { Ece321Content } from "./Ece321content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">ECE 321 Telecommunications I 2 Credits </h1>
