...
import { Ece334Content } from "./Ece334content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">ECE 334  Digital System Design II  2 Credits</h1>
