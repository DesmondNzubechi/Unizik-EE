...
import {Ece517Content } from "./Ece517content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">ECE 517  Real Time Computing and Control 3 Credits</h1>
