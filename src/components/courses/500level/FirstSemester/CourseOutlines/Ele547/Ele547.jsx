...
import { Ele547Content } from "./Ele547content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">ELE 547  Power Electronics and Drives 3 Credits Prerequisite ECE 323  </h1>
