...
import { Ele574Content } from "./Ele574content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">ELE 574  Control Systems  3 Credits. Prerequisite ELE 382 </h1>
