...
import { Ich101Content } from "./Ich101content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">ICH101 Basic Organic Chemistry 2 Credits</h1>
