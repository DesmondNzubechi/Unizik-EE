...
import { Feg102Content } from "./Feg102content";
export const Feg102 = () => {
    return (
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">FEG 102 Engineering Mathematics II 3 Credits </h1>
