...
import { Gst110Content } from "./Gst110content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">GST110 Omenala Igbo 1 Credits</h1>
