...
import { Cve423Content } from "./Cve423content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">CVE 423 Engineering Contracts and Specification 2 Credits</h1>
