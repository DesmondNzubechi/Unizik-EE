...
import { Feg404Content } from "./Feg404content";
export const Feg404 = () => {
    return (
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">FEG 404 Engineering Mathematics IV 3 Credits</h1>
