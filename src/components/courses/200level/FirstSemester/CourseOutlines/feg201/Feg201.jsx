...
import { Feg201Content } from "./Feg201content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">FEG 201 Basic Electricity I 3 Credits</h1>
