...
import { Ich221Content } from "./Ich221content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">ICH 221 General Physical Chemistry 2 Credits </h1>
