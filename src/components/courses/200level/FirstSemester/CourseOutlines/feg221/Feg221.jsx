...
import { Feg221Content } from "./Feg221content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">FEG 221 Fluid Mechanics I 2 Credits</h1>
