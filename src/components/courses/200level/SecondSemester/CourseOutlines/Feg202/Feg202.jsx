...
import { Feg202Content } from "./Feg202content";
export const Feg202 = () => {
    return (
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">FEG 202 Basic Electricity II 3 Credits </h1>
