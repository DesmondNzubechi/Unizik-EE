...
import { Feg214Content } from "./Feg214content";
...
<h1 className="text-center text-slate-900 font-bold uppercase text-[15px] md:text-[20px] my-[10px]">FEG 214 Engineering Drawing II   2 Credits</h1>
