        ...
        <div className="py-[70px] px-[40px] pt-[150px] ">
           ...
           size={100}
            /></div> }
                ...
                <input onChange={(e) => setUserDetails({...userDetails, emailAddress: e.target.value})} value={userDetails.emailAddress} placeholder="Input email" className="shadow bg-transparent border-[2px]  rounded text-white placeholder:text-white outline-0 px-[20px] py-[5px] " type="email" name="email" id="" />
            </div>
            <div  className="flex flex-col ">
                <label className="text-[20px] font-semibold" htmlFor="">Password</label>
                <input onChange={(e) => setUserDetails({...userDetails, password: e.target.value})} value={userDetails.password} className=" shadow text-white placeholder:text-white rounded outline-0 px-[20px] py-[5px] " type="password" placeholder="Input password" name="email" id="" />
            </div>
            <button onClick={signUserIn} className="bg-slate-900 py-[3px]  hover:bg-slate-500 rounded shadow-2xl text-white text-[15px] md:text-[20px] font-semibold " type="button">login</button>
