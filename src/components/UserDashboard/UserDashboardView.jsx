...
export const UserDashboardView = () => {
   ...
   return ( 
        ...
        <div className="flex overflow-x-hidden flex-col gap-[50px]">
             ...
             <div className="text-center   py-[25px] md:min-w-[300px] border-slate-900 border-[5px] border bg-slate-200 gap-2 px-[50px] rounded h-[200px] justify-center py-[10px] flex flex-col items-center">
